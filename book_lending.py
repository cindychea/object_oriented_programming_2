...
# "Sister Outsider" (this value may be different for you)
print(Book.browse().title)
# "Ain't I a Woman?" (this value may be different for you)
...
# 2017-02-25 20:52:20 -0500 (this value will be different for you)
