...
class Zombie:
    ...
    def __init__(self, speed, strength):
        ...
        if speed > Zombie.max_speed:
            ...
            self.speed = speed
        """Inititalizes zombie's strength"""
    ...
    @classmethod
    def new_day(cls):
        """Represents the events of yet another day of the zombie apocalypse. Every day some zombies die off (phew!), 
        some new ones show up, and sometimes the zombie plague level increases."""
        Zombie.spawn()
        Zombie.some_die_off()
    ...
    def encounter(self):
        ...
        2. You fight off the zombie and in turn become a zombie yourself!
        3. You don't outrun or fight off the zombie the zombie. It eats your brains and you die. :(
    ...
    def fight(self):
        ...
        Use `Zombie.max_strength` to generate a random number that represents how well you are able to fight off this zombie."""
        your_strength = random.randint(1, Zombie.max_strength)
        return your_strength > self.strength

    @classmethod
    def increase_plague_level(cls):
        """ Generates a random number between 0 and 2 and increases Zombie.plague_level by that amount.
        Call this method from new day() so the plague spreads a little every day."""
